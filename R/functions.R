...
supertree.phy <- ape::extract.clade(supertree.phy, supertree.phy$node.label[which(grepl("Hexapoda", supertree.phy$node.label))])
grafted.phy <- ape::extract.clade(grafted.phy, grafted.phy$node.label[which(grepl("Hexapoda", grafted.phy$node.label))])

save(supertree.phy, grafted.phy, file="../data/ott.rda")
